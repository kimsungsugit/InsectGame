...
- [ ] WorldFieldMultiplayerUI (UI/WorldFieldMultiplayerUI.cs, 525줄, score 160) — 프레임 할당 51, 미캐싱 조회 1, 싱글턴 참조 5
- [ ] AccountLinkUI (UI/AccountLinkUI.cs, 269줄, score 146) — 프레임 할당 46, 싱글턴 참조 8
- [ ] SubAreaEnvironment (Core/SubAreaEnvironment.cs, 344줄, score 140) — 프레임 할당 46, 미캐싱 조회 1
